...
def build_parser() -> argparse.ArgumentParser:
    ...
    def add_common(cmd):
        cmd.add_argument("--config", default="od_zero_shot/configs/smoke.yaml", help="ProjectConfig YAML 路径")
    ...
    check_data.add_argument("--config", default="od_zero_shot/configs/smoke.yaml")
