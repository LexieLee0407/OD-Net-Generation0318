...
if torch is not None:
    ...
    from od_zero_shot.models.baselines import fit_gravity_from_sample_dicts
...
class CanonicalModelShapeTest(unittest.TestCase):
    ...
    def test_gravity_uses_selfloop_feature(self) -> None:
        ...
        model = fit_gravity_from_sample_dicts([sample])
        self.assertEqual(tuple(model.coefficients.shape), (5,))
